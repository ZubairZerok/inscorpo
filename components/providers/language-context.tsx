...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "hero.subtitle": "Level up your career with INSYT Corporate. Master banking, corporate skills, GRE, GMAT, IELTS, AI productivity and more.",
  ...
  bn: {
    ...
    "hero.subtitle": "ইনসাইট কর্পোরেটের সাথে ক্যারিয়ার গ্রোথ করুন। ব্যাংকিং, কর্পোরেট স্কিলস, জিআরই, জিম্যাট এবং এআই অটোমেশন মাস্টার করুন।",
