...
const DRILL_QUESTIONS: DrillQuestion[] = [
  ...
  },
  {
    ...
    difficulty: "Hard",
    question:
      "If x and y are positive integers such that 3x + 7y = 100, how many distinct ordered pairs (x, y) satisfy this equation?",
    options: [
      "4 pairs",
      "5 pairs",
      "6 pairs",
    ...
    correct: 0,
    explanation:
      "Rewrite as 7y = 100 - 3x. For y to be an integer, (100 - 3x) must be divisible by 7. Testing positive integer values for x where 3x < 100: x = 4 (y = 12), x = 11 (y = 9), x = 18 (y = 6), x = 25 (y = 3). Next would be x = 32 (y = 0, but y must be positive). Thus, exactly 4 valid pairs exist: (4,12), (11,9), (18,6), (25,3).",
    tip: "For linear Diophantine equations ax + by = c, once you find the first solution, subsequent x values change by step b, and y values change by step a.",
  },
  {
    id: 5,
    category: "GRE Verbal",
    ...
    difficulty: "Medium",
    question:
      "Select the pair of words that best completes the sentence: 'Despite the CEO's ________ rhetoric about transparency, the quarterly report was notoriously ________, obscuring real losses behind ambiguous accounting jargon.'",
    options: [
      "ostentatious ... lucid",
      "candid ... pellucid",
      "flamboyant ... opaque",
      "solicitous ... perspicuous",
    ],
    correct: 2,
    explanation:
      "'Flamboyant' (showy/ostentatious) fits the grand rhetoric, while 'opaque' (hard to understand/unclear) directly contrasts transparency by explaining how real losses were obscured behind jargon.",
    tip: "Look for sentence contrast pivot words like 'Despite', 'However', or 'Yet' to signal opposing tone.",
  },
  {
    id: 6,
